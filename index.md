...
#### Запрос
Пользователь будет создан со стандартным паролем, при первом входе ему будет предложено сменить его.  
...
## Изменить аккаунт
#### Запрос
При обновлении **projectIds** нужно передавать все проекты, к которым пользователь должен иметь доступ.
Например: Пользователь имеет доступ к проектам **A** и **C**, и вам нужно предоставить доступ к проекту **B**
